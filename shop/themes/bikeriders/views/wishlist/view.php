...
<div id="wishlistdisplay">
    ...
    <div class="span3">
        <h2><?= Yii::t('global','Wish List') ?>: <?= $model->registry_name; ?></h2>
    ...
    <div class="row rowborder midrow">
        <div class="span6"><span class="cartlabel heading light"><?= Yii::t('global','Products') ?></span></div>
<!--         <div class="span1 cart_price"><span class="cartlabel heading light"><?= Yii::t('global','Qty') ?></span></div>
 -->        <div class="span2"><span class="cartlabel heading light"><?= Yii::t('global','Status') ?></span></div>
        <div class="span1 centeritem"><span class="cartlabel heading light"><?= Yii::t('global','Edit') ?></span></div>
    </div>

	<?php foreach ($model->wishlistItems as $item): ?>
		<?php if ($item->product != null): ?>
		    <div class="row rowborder midrow">
		        <div class="span1 list_item">
