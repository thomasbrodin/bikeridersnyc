...
<?php if (count($model) > 0): ?>
		...
		foreach($model as $objProduct):
			...
			echo CHtml::tag('div',array(
		        'class'=>'product_cell span'.(9/$this->gridProductsPerRow)),
					...
					CHtml::tag('div',array(
				        ...
				        CHtml::link(_xls_truncate($objProduct->Title , 20), $objProduct->Link).
		...
		<div id="paginator" class="span9">
			<?php $this->widget('CLinkPager', array(
				...
				'maxButtonCount'=>5,
				'firstPageLabel'=> '<span class="arrow">←←</span>'.Yii::t('global','First'),
				'lastPageLabel'=> Yii::t('global','Last').' <span class="arrow">→→</span>',
				'prevPageLabel'=> '<span class="arrow">←</span> '.Yii::t('global','Previous'),
				'nextPageLabel'=> Yii::t('global','Next').' <span class="arrow">→</span>',
				'header'=>'',
