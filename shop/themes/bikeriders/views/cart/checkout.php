...
<?php endif; ?>
	...
	<div id="shipping">
		<div class="shippingmethod">
			<div class="span4 left10 module">
				<h1 class="white">HOME INSTALLATION</h1>
					<p>Schedule a pickup and have your order installed on site<br>
					On-Site Service Call fee – $29.99</p>
			</div>
			<div class="span4 module">
				<h1 class="white">SHIPPING</h1>
					<p>Free shipping for all order above $100<br>
						With USPS Priority mail</p>
			</div>
			<div class="span4 module">
				<h1 class="white">IN-STORE PICK UP</h1>
					<p>Our shop is located at <a href="http://goo.gl/maps/ch4MR" target="_blank"><?php echo _xls_get_conf('STORE_ADDRESS1');?></a>.<br>
					Bring your order ID</p>
			</div>
			<legend class="span10 left10"><span class="required">*</span> Enter your address, click to calculate shipping and choose your option below.</legend>
		</div>
		<fieldset class="span12">

			<div class="span4 left10">
	...
	<div id="payment">
		<fieldset class="span12">
			...
			<div class="row spaceafter">
		        If you'd like to check out using one of our gift cards, please call us at 855.692.5737 and we'll facilitate the transaction for you!
	        </div>
            ...
            <div id="CreditCardForm" style="display: none" class="span12 left10">
                <div class="row">
                    <div class="span3">
