...
<div id="genericcart">
    <div class="row">
        ...
        <div class="span1 rightitem"><span class="cart_header"><?= Yii::t('cart','Price'); ?></span></div>
        <div class="span1">&nbsp;</div>
	    ...
	    <div class="row remove-bottom sub">
			<div class="span5">&nbsp;</div>
		    <div class="span2 cart_price"><span class="cart_label"><?= Yii::t('cart','Subtotal'); ?></span></div>
		...
		<div class="row remove-bottom ship">
				<div class="span5">&nbsp;</div>
		        <div class="span2 cart_price"><span class="cart_label"><?= Yii::t('cart',"Shipping"); ?></span></div>
		        <div class="span2 cart_price"><span id="cartShipping"><?= _xls_currency($model->shipping_sell); ?></span></div>
		</div>
		<div class="row remove-bottom total">
				<div class="span5">&nbsp;</div>
		        <div class="span2 cart_price"><?= Yii::t('cart',"Total"); ?></div>
		        <div class="span2 cart_price"><span id="cartTotal"><?= _xls_currency($model->total); ?></span></div>
		</div>
		<?php if($model->PromoCode): ?>
			<div class="row remove-bottom">
				<div class="span5">&nbsp;</div>
			     <div class="span4 promoCode"><?= Yii::t('cart',"Promo Code {code} Applied",array('{code}'=>"<strong>".$model->PromoCode."</strong>")); ?></div>
			</div>
		<?php endif; ?>
	</div>
	<?php if (isset($this->intEditMode) && $this->intEditMode): ?>
		<div class="row">
			<div class="span9 errorMessage">
