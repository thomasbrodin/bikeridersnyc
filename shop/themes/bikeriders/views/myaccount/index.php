...
<div id="orderdisplay">
	...
	<fieldset class="span9">
		<div class="row">
			<div class="span6"><h2><?= Yii::t('global','My Addresses') ?>:</h2></div>
			<div class="span3 subcategories right"><?= CHtml::link(Yii::t('global','Add new address'),Yii::app()->createUrl('myaccount/address')); ?></div>
		</div>
	...
	<fieldset class="span9">
	    <div class="row">
	        <div class="span6"><h2><?= Yii::t('global','My Orders') ?>:</h2></div>
	    </div>
	...
	<fieldset class="span9">
	    <div class="row">
	        <div class="span6"><h2><?= CHtml::link(Yii::t('global','My Wish Lists'),Yii::app()->createUrl('/wishlist')); ?></h2></div>
	        <div class="span3 subcategories right"><?= CHtml::link(Yii::t('global','Click here to create a wish list.'),Yii::app()->createUrl('wishlist/create')); ?></div>
	    </div>
	    <div class="row">
	...
	<fieldset class="span9">
	    <div class="row">
	        <div class="span6"><h2><?= Yii::t('global','My Repairs') ?></h2></div>
	    </div>
	    <div class="row">
