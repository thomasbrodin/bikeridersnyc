	...
	<div id="shoppingcarttop" class="rounded-top">
        <span class="title"><?php echo CHtml::link(Yii::t('cart','n==1#Shopping Cart ({n})|n>1#Shopping Cart ({n})',Yii::app()->shoppingcart->totalItemCount),array('cart/index'),array('target'=>'_top')) ?></span><span class="carticon">&nbsp;</span>
		...
		<?php if(!empty(Yii::app()->shoppingcart)):
			foreach (Yii::app()->shoppingcart->cartItems as $item): ?>
				...
				<div id="cartline<?=$item->id?>" class="minicart_item">
						...
						<span class="span2 minicart_desc">
	...
	<div id="shoppingcartbottom">
		<div class="cart_label span2"><span class="subtotallabel"><?php echo Yii::t('cart','SubTotal'); ?></span></div>
		<div class="cart_price span1"><span id="subtotal"><?= _xls_currency(Yii::app()->shoppingcart->subtotal) ?></span>&nbsp;&nbsp;</div>
	</div>
