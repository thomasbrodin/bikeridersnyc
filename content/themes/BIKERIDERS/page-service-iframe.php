...
<?php 
/*
Template Name: Book Performance Lab 
*/
global $bk;
the_post();
        ...
        <div class="container overlay">
            ...
            <div class="eight columns">
                <script type="text/javascript">
                        ...
                        var schedule_form = "appointment_form";
                        var schedule_form_id = "appointment_form";
                        </script>
                        <script type="text/javascript" src="/scheduler/scheduler.js"></script>

                        <div id="appointment_form" class="iframe">[scheduling form will load here]</div>
             </div>
          </div>
