...
Advanced Order Post Types Objects using a Drag and Drop Sortable javascript capability
...
1. Upload `advanced-post-types-order` folder to your `/wp-content/plugins/` directory.
...
5. For advanced usage check API at http://www.nsp-code.com/advanced-post-types-order-api/
